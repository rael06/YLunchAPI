...
public class RestaurantsControllerTest : UnitTestFixture
{
    ...
    public async Task GetRestaurants_Should_Return_A_200Ok()
    {
        ...
        {
            await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant1", dateTime), dateTime),
            await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant2", dateTime), dateTime)
        };
    ...
    public async Task GetRestaurants_With_Pagination_Should_Return_A_200Ok_With_Correct_Restaurants()
    {
        ...
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant1", dateTime), dateTime);
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant2", dateTime), dateTime);
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant3", dateTime), dateTime);
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant4", dateTime), dateTime);
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant5", dateTime), dateTime);
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant6", dateTime), dateTime);
        var expectedRestaurants = new List<RestaurantReadDto>
        {
            await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant7", dateTime), dateTime),
            await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant8", dateTime), dateTime)
        };
        ...
        GetRestaurants_With_Filter_IsCurrentlyOpenToOrder_True_Should_Return_A_200Ok_With_Correct_Restaurants()
    {
        ...
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurant1, dateTime);

        var restaurant2 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant2", dateTime), dateTime);

        var restaurant3 = RestaurantMocks.SimpleRestaurantCreateDto;
        restaurant3.Name = "restaurant3";
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurant3, dateTime);

        var restaurant4 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant4", dateTime), dateTime);

        var restaurant5 = RestaurantMocks.SimpleRestaurantCreateDto;
        restaurant5.Name = "restaurant5";
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurant5, dateTime);

        var restaurant6 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant6", dateTime), dateTime);

        var restaurant7 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant7", dateTime), dateTime);
        ...
        GetRestaurants_With_Filter_IsCurrentlyOpenToOrder_False_Should_Return_A_200Ok_With_Correct_Restaurants()
    {
        ...
        var restaurant3 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurantCreateDto3, dateTime);

        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant4", dateTime), dateTime);

        var restaurantCreateDto5 = RestaurantMocks.SimpleRestaurantCreateDto;
        restaurantCreateDto5.Name = "restaurant5";
        var restaurant5 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurantCreateDto5, dateTime);
    ...
    public async Task GetRestaurants_With_Filter_IsPublished_True_Should_Return_A_200Ok_With_Correct_Restaurants()
    {
        ...
        await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, restaurant8, dateTime);
        ...
        GetRestaurants_With_Filter_RestaurantAdminId_Should_Return_A_200Ok_With_Correct_Restaurants()
    {
        ...
        await CreateRestaurant(TokenMocks.ValidRestaurantAdmin2AccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant1", dateTime), dateTime);

        var restaurant2 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant2", dateTime), dateTime);

        await CreateRestaurant(TokenMocks.ValidRestaurantAdmin2AccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant3", dateTime), dateTime);

        var restaurant4 = await CreateRestaurant(TokenMocks.ValidRestaurantAdminAccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant4", dateTime), dateTime);

        await CreateRestaurant(TokenMocks.ValidRestaurantAdmin2AccessToken, RestaurantMocks.PrepareFullRestaurant("restaurant5", dateTime), dateTime);
